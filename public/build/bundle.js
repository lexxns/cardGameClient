...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h21 = element("h2");
    			t6 = text(t6_value);
    			attr_dev(h3, "class", "title svelte-x569hm");
    			add_location(h3, file, 14, 8, 400);
    			attr_dev(div0, "class", "emptybar svelte-x569hm");
    			add_location(div0, file, 16, 12, 479);
    			attr_dev(div1, "class", "filledbar svelte-x569hm");
    			add_location(div1, file, 17, 12, 521);
    			attr_dev(div2, "class", "bar svelte-x569hm");
    			add_location(div2, file, 15, 8, 448);
    			add_location(h20, file, 20, 12, 608);
    			attr_dev(div3, "class", "attk svelte-x569hm");
    			add_location(div3, file, 19, 8, 576);
    			add_location(h21, file, 23, 12, 697);
    			attr_dev(div4, "class", "def svelte-x569hm");
    			add_location(div4, file, 22, 8, 658);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(14:4) {#if cardData.isFaceUp}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "card svelte-x569hm");
    ...
    */
    ...
    // (22:2) {#each fieldData.field as card}
    function create_each_block_1(ctx) {
    	let card;
    	let current;

    	card = new Card({
    			props: { cardData: /*card*/ ctx[3], onField: true },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(22:2) {#each fieldData.field as card}",
    		ctx
    	});
    ...
    // (28:2) {#each handData.hand as card}
    function create_each_block(ctx) {
    	let card;
    	let current;

    	card = new Card({
    			props: { cardData: /*card*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*handData*/ 1) card_changes.cardData = /*card*/ ctx[3];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:2) {#each handData.hand as card}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 20, 1, 416);
    			attr_dev(div1, "class", "hand svelte-s03qdo");
    			add_location(div1, file$1, 26, 1, 532);
    			attr_dev(main, "class", "svelte-s03qdo");
    			add_location(main, file$1, 19, 0, 408);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		store.subscribe(currentMessage => {
    			$$invalidate(0, handData = currentMessage);
    		});
    	});
