...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	let t1;
    	let p1;
    	let t2_value = /*cardData*/ ctx[0].attk + "";
    	let t2;
    	let t3;
    	let p2;
    	let t4_value = /*cardData*/ ctx[0].health + "";
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			p2 = element("p");
    			t4 = text(t4_value);
    			add_location(p0, file, 14, 8, 400);
    			add_location(p1, file, 15, 8, 432);
    			add_location(p2, file, 16, 8, 464);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*cardData*/ 1 && t2_value !== (t2_value = /*cardData*/ ctx[0].attk + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*cardData*/ 1 && t4_value !== (t4_value = /*cardData*/ ctx[0].health + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "card svelte-g621sq");
    ...
    */
    ...
    // (21:1) {#each fieldData.field as card}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:1) {#each fieldData.field as card}",
    		ctx
    	});
    ...
    // (24:1) {#each handData.hand as card}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:1) {#each handData.hand as card}",
    		ctx
    	});
