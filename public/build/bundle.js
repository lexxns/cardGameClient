...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h21 = element("h2");
    			t6 = text(t6_value);
    			attr_dev(h3, "class", "title svelte-cx2u6a");
    			add_location(h3, file, 15, 8, 423);
    			attr_dev(div0, "class", "emptybar svelte-cx2u6a");
    			add_location(div0, file, 17, 12, 502);
    			attr_dev(div1, "class", "filledbar svelte-cx2u6a");
    			add_location(div1, file, 18, 12, 544);
    			attr_dev(div2, "class", "bar svelte-cx2u6a");
    			add_location(div2, file, 16, 8, 471);
    			add_location(h20, file, 21, 12, 631);
    			attr_dev(div3, "class", "attk svelte-cx2u6a");
    			add_location(div3, file, 20, 8, 599);
    			add_location(h21, file, 24, 12, 720);
    			attr_dev(div4, "class", "def svelte-cx2u6a");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "card svelte-cx2u6a");
    ...
    */
    ...
    const store = writable({ hand: [], field: [] });
    ...
    // (17:2) {#each gameData.field as card}
    function create_each_block_1(ctx) {
    	let card;
    	let current;

    	card = new Card({
    			props: { cardData: /*card*/ ctx[1], onField: true },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*gameData*/ 1) card_changes.cardData = /*card*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:2) {#each gameData.field as card}",
    		ctx
    	});
    ...
    // (23:2) {#each gameData.hand as card}
    function create_each_block(ctx) {
    	let card;
    	let current;

    	card = new Card({
    			props: { cardData: /*card*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:2) {#each gameData.hand as card}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let div1;
    	let current;
    	let each_value_1 = /*gameData*/ ctx[0].field;
    	...
    	let each_value = /*gameData*/ ctx[0].hand;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 15, 1, 273);
    			attr_dev(div1, "class", "hand svelte-cflimc");
    			add_location(div1, file$1, 21, 1, 388);
    			attr_dev(main, "class", "svelte-cflimc");
    			add_location(main, file$1, 14, 0, 265);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*gameData*/ 1) {
    				each_value_1 = /*gameData*/ ctx[0].field;
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*gameData*/ 1) {
    				each_value = /*gameData*/ ctx[0].hand;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let gameData = { hand: [], field: [] };

    	onMount(() => {
    		store$1.subscribe(data => {
    			$$invalidate(0, gameData = data);
    		});
    	});
    	...
    	$$self.$capture_state = () => ({ Card, onMount, store: store$1, RS, gameData });
