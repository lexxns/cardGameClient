...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file, 14, 8, 437);
    			attr_dev(div0, "class", "emptybar svelte-cx2u6a");
    			add_location(div0, file, 16, 12, 516);
    			attr_dev(div1, "class", "filledbar svelte-cx2u6a");
    			add_location(div1, file, 17, 12, 558);
    			attr_dev(div2, "class", "bar svelte-cx2u6a");
    			add_location(div2, file, 15, 8, 485);
    			add_location(h20, file, 20, 12, 645);
    			attr_dev(div3, "class", "attk svelte-cx2u6a");
    			add_location(div3, file, 19, 8, 613);
    			add_location(h21, file, 23, 12, 734);
    			attr_dev(div4, "class", "def svelte-cx2u6a");
    			add_location(div4, file, 22, 8, 695);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "field", /*cardData*/ ctx[0].container == "FIELD");
    			toggle_class(div, "hand", /*cardData*/ ctx[0].container == "HAND");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*toggleSelect*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ CardData, cardData, toggleSelect });
    ...
    */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*cards*/ 1) card_changes.cardData = /*card*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(16:3) {#if card.container == \\\"FIELD\\\"}",
    		ctx
    	});
    ...
    // (15:2) {#each cards as card}
    function create_each_block_1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*card*/ ctx[1].container == "FIELD" && create_if_block_1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:2) {#each cards as card}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(24:3) {#if card.container == \\\"HAND\\\"}",
    		ctx
    	});
    ...
    // (23:2) {#each cards as card}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*card*/ ctx[1].container == "HAND" && create_if_block$1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:2) {#each cards as card}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "field svelte-mhjk72");
    			add_location(div0, file$1, 13, 1, 232);
    			attr_dev(div1, "class", "hand svelte-mhjk72");
    			add_location(div1, file$1, 21, 1, 368);
    			attr_dev(main, "class", "svelte-mhjk72");
    			add_location(main, file$1, 12, 0, 224);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Card, onMount, store: store$1, cards });
