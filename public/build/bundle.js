...
var app = (function () {
    ...
    /* src/Card.svelte generated by Svelte v3.29.0 */
    ...
    // (15:4) {#if cardData.isFaceUp}
    function create_if_block(ctx) {
    	let h3;
    	let t0_value = /*cardData*/ ctx[0].name + "";
    	let t0;
    	let t1;
    	let div2;
    	let div0;
    	...
    	let div3;
    	let h20;
    	let t4_value = /*cardData*/ ctx[0].attk + "";
    	let t4;
    	let t5;
    	let div4;
    	let h21;
    	let t6_value = /*cardData*/ ctx[0].health + "";
    	let t6;
    	...
    	const block = {
    		c: function create() {
    			...
    			h21 = element("h2");
    			t6 = text(t6_value);
    			attr_dev(h3, "class", "title svelte-hf38zh");
    			add_location(h3, file, 15, 8, 423);
    			attr_dev(div0, "class", "emptybar svelte-hf38zh");
    			add_location(div0, file, 17, 12, 502);
    			attr_dev(div1, "class", "filledbar svelte-hf38zh");
    			add_location(div1, file, 18, 12, 544);
    			attr_dev(div2, "class", "bar svelte-hf38zh");
    			add_location(div2, file, 16, 8, 471);
    			add_location(h20, file, 21, 12, 631);
    			attr_dev(div3, "class", "attk svelte-hf38zh");
    			add_location(div3, file, 20, 8, 599);
    			add_location(h21, file, 24, 12, 720);
    			attr_dev(div4, "class", "def svelte-hf38zh");
    			add_location(div4, file, 23, 8, 681);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*cardData*/ 1 && t0_value !== (t0_value = /*cardData*/ ctx[0].name + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*cardData*/ 1 && t4_value !== (t4_value = /*cardData*/ ctx[0].attk + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*cardData*/ 1 && t6_value !== (t6_value = /*cardData*/ ctx[0].health + "")) set_data_dev(t6, t6_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(15:4) {#if cardData.isFaceUp}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*cardData*/ ctx[0].isFaceUp) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "card svelte-hf38zh");
    			toggle_class(div, "selected", /*cardData*/ ctx[0].isSelected);
    			toggle_class(div, "field", /*onField*/ ctx[1]);
    			toggle_class(div, "hand", !/*onField*/ ctx[1]);
    			add_location(div, file, 9, 0, 255);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*toggleSelect*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { onField = false } = $$props;
    	let { cardData = new CardData("DEFAULT_NAME") } = $$props;

    	function toggleSelect() {
    		$$invalidate(0, cardData.isSelected = !cardData.isSelected, cardData);
    		$$invalidate(0, cardData.isFaceUp = true, cardData);
    	}

    	const writable_props = ["onField", "cardData"];
    	...
    	$$self.$$set = $$props => {
    		if ("onField" in $$props) $$invalidate(1, onField = $$props.onField);
    	...
    	return [cardData, onField, toggleSelect];
    }

    class Card extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { onField: 1, cardData: 0 });
    ...
    var neffos = createCommonjsModule(function (module, exports) {
    ...
    */
    ...
    const fieldStore = writable({ field: [] });
    ...
    // (24:2) {#each fieldData.field as card}
    function create_each_block_1(ctx) {
    	let card;
    	let current;

    	card = new Card({
    			props: { cardData: /*card*/ ctx[2], onField: true },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*fieldData*/ 2) card_changes.cardData = /*card*/ ctx[2];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:2) {#each fieldData.field as card}",
    		ctx
    	});
    ...
    // (30:2) {#each handData.hand as card}
    function create_each_block(ctx) {
    	let card;
    	let current;

    	card = new Card({
    			props: { cardData: /*card*/ ctx[2] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*handData*/ 1) card_changes.cardData = /*card*/ ctx[2];
    			card.$set(card_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:2) {#each handData.hand as card}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let div1;
    	let current;
    	let each_value_1 = /*fieldData*/ ctx[1].field;
    	...
    	let each_value = /*handData*/ ctx[0].hand;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "field svelte-cflimc");
    			add_location(div0, file$1, 22, 1, 458);
    			attr_dev(div1, "class", "hand svelte-cflimc");
    			add_location(div1, file$1, 28, 1, 574);
    			attr_dev(main, "class", "svelte-cflimc");
    			add_location(main, file$1, 21, 0, 450);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*fieldData*/ 2) {
    				each_value_1 = /*fieldData*/ ctx[1].field;
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*handData*/ 1) {
    				each_value = /*handData*/ ctx[0].hand;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		store.subscribeHand(hand => {
    			$$invalidate(0, handData = hand);
    		});

    		store.subscribeField(field => {
    			$$invalidate(1, fieldData = field);
    		});
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("handData" in $$props) $$invalidate(0, handData = $$props.handData);
    		if ("fieldData" in $$props) $$invalidate(1, fieldData = $$props.fieldData);
    	};
